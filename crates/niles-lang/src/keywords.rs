...
pub static KEYWORDS: &[Keyword] = &[
    ...
    kw!("end", End, Reserved, RequiresAs, Sql, "2026", "Closes a `case` expression.", "case when p then a else b end"),
    ...
    kw!("from", From, Reserved, RequiresAs, Sql, "2026", "Source relation, in the SQL surface and in `delete`.", "sql { select id from accounts }"),
    ...
    kw!("group", Group, Reserved, RequiresAs, Sql, "2026", "Introduces grouping; the pipeline spelling is `group_by`.", "group_by(|r| (r.acct, r.cur))"),
    ...
    kw!("limit", Limit, Reserved, RequiresAs, Sql, "2026", "Bound the result cardinality.", "order_by(|r| desc(r.amt)).limit(10)"),
    ...
    kw!("offset", Offset, Reserved, RequiresAs, Sql, "2026", "Skip a prefix of the result.", "order_by(|r| r.id).offset(20).limit(10)"),
    ...
    kw!("order", Order, Reserved, RequiresAs, Sql, "2026", "Introduces ordering; the pipeline spelling is `order_by`.", "order_by(|r| asc(r.id))"),
    ...
    kw!("values", Values, Reserved, RequiresAs, Sql, "2026", "Literal row constructor.", "insert into accounts values (1, \"ada\");"),
