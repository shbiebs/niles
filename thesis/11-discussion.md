...
* A fixed policy beating the adaptive optimizer across the workload suite would reduce C5 to a planning-time heuristic. The measured margin of cost-aware eviction over LRU is real but uneven — 31% on reconstruction work, 4% on aggregate delay (§9.4.2) — so this one is closer to the edge than the others.
